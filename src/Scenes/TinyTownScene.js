class TinyTown extends Phaser.Scene {
    ...
    create() {
        ...
        this.enviromentlayer = this.map.createLayer("Extra-Enviroment", this.tileset, 0, 0);
        this.grassLayer.setScale(4.0);
        this.treeLayer.setScale(4.0);
        this.enviromentlayer.setScale(4.0);

        document.getElementById('description').innerHTML = '<h2>Welcome to Bobby Land!</h2>';
    }
